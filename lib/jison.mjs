import _typal from "./util/typal.js";
const { typal } = _typal;
import _set from "./util/set.js";
const { Set } = _set;
import Lexer from "../jison-lex.js";
...
(function () {
  ...
  lrGeneratorMixin.generate = function parser_generate(opt) {
    ...
    switch (opt.moduleType) {
      case "js":
        ...
        break;
      case "es6":
        code = this.generateES6Module(opt);
        break;
      case "amd":
  ...
  lrGeneratorMixin.generateES6Module = function (opt) {
    opt = typal.mix.call({}, this.options, opt);
    const moduleName = opt.moduleName || "parser";
    return `
${this.generateModule(opt)}

const ___parser = ${moduleName};
const ___Parser = ${moduleName}.Parser;
const ___parse = ${moduleName}.parse.bind(${moduleName});
export {
___parser as parser,
___Parser as Parser,
___parse as parse 
